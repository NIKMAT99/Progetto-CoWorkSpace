...
exports.createSpace = async (req, res) => {
    const { location_id, type, description, services, price, image_url = null } = req.body;
    try {
        await pool.query(
            'INSERT INTO spaces (location_id, type, description, services, price, image_url) ' +
            'VALUES ($1, $2, $3, $4, $5, $6)',
            [location_id, type, description, services, price, image_url ]
        );
